...
public class GrabbedItem : MonoBehaviour
{
    ...
    public UnityEngine.XR.Interaction.Toolkit.Interactors.IXRSelectInteractor interactor;
    ...
    public void Grab(UnityEngine.XR.Interaction.Toolkit.Interactors.IXRSelectInteractor hand){
        interactor = hand;
    ...
    public void ForceDrop(){
        GameObject.Find("XR Interaction Manager").GetComponent<InteractionManager>().ForceDrop(interactor, this.gameObject.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>());
