...
namespace Oculus.Movement.Tracking
{
    ...
    /// modifiers.
    /// </summary>
    public class MyCorrectivesFace : OVRCustomFace
    {
        ...
        protected override void Update()
        {
                ...
                _faceExpressions.ValidExpressions)
            {
                ...
                //UpdateExpressionWeightFromRemote(PrepareRemoteExpressionWeights());
                InitializeCachedValues();
                UpdateCachedMeshValues();
                if (_correctivesModule != null && CorrectivesEnabled)
                {
        ...
        {
            if (FreezeExpressionWeights || remoteExpressionWeights == null)
            {
                return;
            }
